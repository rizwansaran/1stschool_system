...
<?php
   $id= $_SESSION['id'];
                        $query5 = "SELECT * FROM `parent` WHERE `id`= '$id'";
                        $result5 = mysqli_query($link, $query5);
                       $row = mysqli_fetch_array($result5);
    
                        ?>
                                		         <img src="<?php echo $row['image2'];?>" class="img-responsive" width="60" height="60"  alt="<?php echo $row['dad']; ?>"/>	
...
<table class="table">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th scope="row">2</th>
                                                <td>Father Name</td>
                                                <td><b><?php echo $row['dad']; ?></b></td>
                                                
                                            </tr>
                                            <tr>
                                                <th scope="row">3</th>
                                                <td>Father CNIC No.</td>
                                                <td><b><?php echo  $row['fcnic']; ?></b></td>
...
<?php	$fname= $row['dad'];
$mname= $row['fcnic'];										
$query1 = "SELECT DISTINCT address FROM `student` WHERE `fname`= '$fname' AND `fcnic`= '$mname' ";
...
$address= $row1['address'];
                   ...
                   ?> <tr>
                                                <th scope="row">4</th>
                                                <td colspan="2">Address<br><i><?php echo $address; ?></i></td>
