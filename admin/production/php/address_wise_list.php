  ...
  <body class="nav-md">
   ...
   <?php if(!isset($_POST['address'])){
                  ...
                  <div class="col-md-8"><div class="row">
                        <select id="class" class="form-control" name="address" style="width:50%;" >
<?php

 $query1 = "SELECT DISTINCT address FROM `student`ORDER BY address ASC ";
...
<?php
                        ...
                        $query1 = "SELECT * FROM `student` WHERE `address`='$address' AND `status`='Active'";
                        $result1 = mysqli_query($link, $query1);
            ...
            <th class="column-title" style="text-align:center; border: 1px solid #dddddd;">File No.</th>
                        ...
                        <?php
                       // $class = $_POST['class'];
                        $query = "SELECT * FROM `student` WHERE `address`='$address'  AND `status`='Active'";
