...
$year = date("Y"); 
 ...
 $query = "SELECT * FROM `atd` WHERE `class`='$class' AND `section`='$section' AND `date`='$date1' AND `status`='0' ";
...
$msg="No Student Absent On this Date";

}
 echo "<script type='text/javascript'>window.location.href ='sms_attendance_daily112.php?msg=$msg';</script>";
