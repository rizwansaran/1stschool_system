...
?>
    ...
    <input type="hidden" value="<?php echo $id; ?>" name="id"/>
                        ...
                        <div class="col-md-3">  <select id="term"   placeholder='Type here' class="form-control" name="term"  >
...
$batch= $row123['batch'];
 ...
 $query13 = "SELECT DISTINCT term FROM `result` WHERE `year`='$batch' AND `studentid`='$id' ORDER BY term ASC ";
...
<td class=" "><h3  style="text-align:center; border: 0px solid black;"> <small> </small></h3> </td>   
 ...
 <th class="column-title"  style="text-align:center; border: 1px solid black;">Status </th>
                        ...
                        <tbody>
                          <tr class="even pointer"  style="border: 1px solid black;">
