...
$_SESSION["std_id"]=$id;
 ...
 <div class="col-md-3"><h4><b>Admission #:</b> <?php echo $student['id'];?></h4></div>
                         ...
                         <button type="Button" onclick="window.location.href='fee_concession.php?student_id=<?php echo $student['id'];?>';" name="submit_fee" style="float:left; width:140px;" class="btn btn-primary form-control"> Fee Concession </button>
                        
                         <button type="Button" onclick="window.location.href='fee_extra.php?student_id=<?php echo $student['id'];?>';" name="submit_fee" style="float:center; width:140px;" class="btn btn-primary form-control"> Extra Charges </button>
                         
                          <button type="Button" onclick="window.location.href='feehistory2.php?sid=<?php echo $student['id'];?>';" name="submit_fee" style="float:right; width:140px;" class="btn btn-primary form-control"> Fee Receipts </button>
