...
<html lang="en">
 ...
 $query1 = "SELECT * FROM `staff` WHERE `id`='$staff' ";
                        ...
                        <table class="table table-striped jambo_table bulk_action">
                          ...
                          <h2>Name of Staff: <?php echo $r['fullname'];?></h2><hr>
...
$year = date("Y"); 
 ...
 $query = "SELECT * FROM `staff_atd` WHERE `t_id`='$id' AND `month`='$date1' AND `year`='$year'";
                        ...
                        ?>
                           <td class=" " style="text-align:center; border: 1px solid #dddddd;"><?php echo $count; ?></td>
                            ...
                            <td class=" " style="text-align:center; border: 1px solid #dddddd;"><?php  $dd=$row['date']; echo date("d-m-Y", strtotime($dd))?>
                             ...
                             <td class=" " style="text-align:center;border: 1px solid #dddddd;"><?php  $dd=$row['ctime']; echo date("H:i:s", strtotime($dd))?>
                            </td>
...
$query11 = "SELECT * FROM `staff_atd` WHERE `t_id`='$id' AND `month`='$date1' AND `year`='$year' AND `status`='0'";
                        $result11 = mysqli_query($link, $query11);
                        $absents= mysqli_num_rows( $result11);
$query12 = "SELECT * FROM `staff_atd` WHERE `t_id`='$id' AND `month`='$date1' AND `year`='$year' AND `status`='1'";
