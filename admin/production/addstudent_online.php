  ...
  $login ="student-$id";
    ...
    if ($uploadOk == 0) {
        ...
        if (move_uploaded_file($_FILES["image"]["tmp_name"], $image)) {
          $query = "INSERT INTO `student`(`id`, `fullname`, `gender`, `picture`, `dob`, `mobile`, `address`, `class`,`batch`, `bform`, `fname`, `mname`, `fcnic`, `admission_date`,`foccupation`, `login`, `password`,`addedby`) 
VALUES ('$id','$fullname', '$gender', '$image', '$dob', '$mobile','$address','$class','$batch','$bform','$fathername','$mothername','$fcnic','$admissiondate','$foccupation','$login','$password','$addedby')";
...
$student_id1= $row['id'];
$student_id= $student_id1 + 1;
                        ?>


                       <label for="fullname">Admission # * :</label>

   <input type="hidden" id="fullname" value="<?php echo $student_id; ?>" class="form-control" name="id"  required />

                      <input type="text" id="fullname" value="<?php echo $student_id; ?>" class="form-control" disabled   /> <br/>
</div>
 <div class="col-md-6 col-xs-6">
