...
function myFunction()
{
  ...
  <body class="nav-md">
   ...
   <?php if(!isset($_POST['class'])){
                      ?>
                    <form action="allclasses1.php" method="post">
...
<?php
                        $batch = $_POST['class'];
                        $query1 = "SELECT * FROM `student` WHERE `class`='$batch' AND `status`='Active'";
                        $result1 = mysqli_query($link, $query1);
...
<th class="column-title" style="text-align:center; border: 1px solid #dddddd;">Picture </th>      </tr>
                        </thead>
...
$c=1;
                        ...
                        ?>
                         <tr class="even pointer"> <td class=" " style="text-align:center; border: 1px solid #dddddd;"><?php echo $c; ?></td>
