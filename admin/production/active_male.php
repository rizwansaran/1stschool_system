...
<?php
                        ...
                        $query1 = "SELECT * FROM `student` WHERE `status`='Active' AND `gender`='M' ";
...
<th class="column-title" style="text-align:center; border: 1px solid #dddddd;">Take Action </th>
                        ...
                        $query = "SELECT * FROM `student` WHERE `status`='Active' AND `gender`='M'";
...
<li><a href="views_attendance_monthly_std.php?sid=<?php echo $row['id'];?>"><button type="button" class="form-control btn btn-primary">Monthly Attendance </button></a></li>													
