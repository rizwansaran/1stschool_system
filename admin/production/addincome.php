...
$year= date('Y', strtotime($date));
    $price =  $_POST['price'];
    $query = "INSERT INTO `income`(`item_name`, `item_price`, `date`, `day`, `month`, `year`) VALUES ('$name', '$price','$date','$day','$month','$year')";
          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>Income - </h3>  <h2 style="color:red"> <?php echo $error; 
                  ?></h2>
              </div>
            </div>
...
<div class="col-xl-4 col-md-4 col-xs-12">
  <h2 style="color:red">Add Income </h2>
                    <!-- start form for validation -->
<?php if(isset($_GET['edit_id'])){

$edit_id=$_GET['edit_id'];
$query = "SELECT * FROM `income` WHERE `id`='$edit_id' ";
                        $result = mysqli_query($link, $query);
...
$year= date('Y', strtotime($date));
    ...
    $query = "UPDATE `income` SET `item_name`='$name',`item_price`='$price',`day`='$date',`month`='$month',`year`='$year' WHERE `id`='$staff'";
          $result = mysqli_query($link, $query);
...
<button onclick="location.href='addincome.php?edit_id=<?php echo $row['id']; ?>'" class="btn"><i class="fa fa-edit"></i> </button>
<button onclick="location.href='addincome.php?id=<?php echo $row['id']; ?>'" class="btn"><i class="fa fa-trash"></i> </button>
