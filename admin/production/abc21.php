...
$books = $_POST['books'];
  ...
  $discount = $_POST['discount'];
    ...
    $query = "INSERT INTO `chalan1`(`studentid`, `class`, `feemonth`, `year`, `registrationfee`, `admfee`, `teutionfee`, `books`, `uniform`, `discount`) VALUES ('$id','$class', '$month', '$year','$rfee', '$efee', '$tefee', '$books', '$uniform', '$discount')";
    $result = mysqli_query($link, $query);
   if($result=="TRUE"){
          $error = "Updated Successfully";
header("location:Registered_students.php?msg=Chalan Genrated Successfully");
exit();
...
header("location:Registered_students.php?msg=Error While Genrating Chalan...");
}
...
?>
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <input type="number" name="registrationfee" class="form-control"/>
<h3>Admission fee</h3>
<input type="number" name="admfee"   class="form-control"/>
<h3>Tuition fee</h3>
<input type="number" name="teutionfee"  class="form-control"/>
<h3>Books</h3>
<input type="number" name="books"  class="form-control"/>
<h3>Uniform</h3>
<input type="number" name="uniform"  class="form-control"/>
<h3>Discount</h3>
