...
<?php
 ...
 $query1 = "SELECT DISTINCT subject FROM `subject` WHERE `class`='$class' AND `section`='$section' ORDER BY subject ASC";
                        $result1 = mysqli_query($link, $query1);
...
$subject = $_POST['subject'];
                        $class = $_POST['class'];
$section = $_POST['section'];
   $query3 ="DELETE FROM `subject` WHERE `class`='$class' AND `subject`='$subject' AND `section`='$section'";
