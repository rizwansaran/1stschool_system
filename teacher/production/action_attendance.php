...
?>
 ...
 <div class="col-md-12 col-sm-12 col-xs-12">
                         ...
                         <h2 style="color:red">Record Already Exists!...</h2> </div>
...
<button type="submit" name="delete" class="form-control btn btn-primary pull-center" style="width:15%;">Delete</button>    
                   </div>    </form> </div>
    <div class="col-md-6 col-sm-12 col-xs-12">
...
<input  class="form-control" type="hidden" required="" name ="section" value="<?php echo $section; ?>" style="width:50%;">
                          ...
                          <div class="form-group"> 
<button type="submit"  class="form-control btn btn-primary pull-center" style="width:15%;">Edit</button>    
               </div>       </form> </div>
                      </div></div>
...
Leave:
 ...
 <td class=" " style="text-align:center;">
 <input type="text" class="flat" name="remarks[]<?php echo $row['id']; ?>" id="genderM"  required /> 
</td>
                            <input  class="form-control" type="hidden" required="" name ="date" value="<?php echo $date; ?>" style="width:50%;">
