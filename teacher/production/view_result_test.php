...
<?php
 $teacher= $_SESSION['id'];
 $section=$_POST['section'];
$quer11 = "SELECT DISTINCT subject FROM `result1` WHERE `t_id`=' $teacher' AND `class`='$class' AND `section`='$section' AND `term`='$term' AND `month`='$month' ";
 ...
 while($row11 = mysqli_fetch_array($resul11)) {
                          ...
                          $subj=$row11['subject'];
 $query4 = "SELECT total FROM `result1` WHERE `subject`= '$subj' AND `term`='$term' AND `t_id`=' $teacher'  AND `class`='$class' AND `section`='$section'AND `month`='$month' ";
 ...
 ?>
                        ...
                        $query2 = "SELECT DISTINCT studentid, section FROM `result1` WHERE `class`='$class' AND `section`='$section' AND `term`='$term' AND `month`='$month'";
...
else
{
  $query13 = "SELECT * FROM `student` WHERE `id`='$stid' AND `class`='$class'  AND `gender`='$section' AND `status`='Active'";
                       ...
                       $r = mysqli_fetch_array($result13);
                         $teacher= $_SESSION['id'];
 $section=$_POST['section'];
$query23 = "SELECT DISTINCT subject FROM `result1` WHERE `t_id`=' $teacher' AND `class`='$class' AND `section`='$section' AND `term`='$term' AND `month`='$month' ";
                        $result12 = mysqli_query($link, $query23);
                         ...
                         while($row12 = mysqli_fetch_array($result12))
                         {
                          ...
                          $query3 = "SELECT marks FROM `result1` WHERE `subject`= '$sub' AND `studentid`='$stid' AND `section`='$section' AND `term`='$term' AND `month`='$month'";
