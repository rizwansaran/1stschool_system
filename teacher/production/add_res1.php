...
elseif($d <= $date1){
  ...
  $term = $_POST['term'];
 $query17 = "SELECT * FROM `result` WHERE `class`='$class' AND `subject`='$subject' AND `term`='$term' AND `t_id`='$teacher' AND `section`='$section' AND `year`='$year' ";
...
<form action="action_res1.php" method="post">
<input  class="form-control" type="hidden" required="" name ="term" value="<?php echo $term; ?>" style="width:50%;">

<input  class="form-control" type="hidden" required="" name ="class" value="<?php echo $class; ?>" style="width:100%;">

<input  class="form-control" type="hidden" required="" name ="section" value="<?php echo $section; ?>" style="width:100%;">
<input  class="form-control" type="hidden" required="" name ="year" value="<?php echo $year; ?>" style="width:50%;">

<input  class="form-control" type="hidden" required="" name ="subject" value="<?php echo $subject; ?>" style="width:100%;">

<input  class="form-control" type="hidden" required="" name ="tid" value="<?php echo $_SESSION['id']; ?>" style="width:100%;">


                       <div class="form-group">
<button type="submit" name="submit1" class="form-control btn btn-primary pull-right" style="width:50%;">Delete</button>    
                       </form>
     
                 
<form action="edit_res1.php" method="post">
<input  class="form-control" type="hidden" required="" name ="term" value="<?php echo $term; ?>" style="width:45%;">
...
<input  class="form-control" type="hidden" required="" name ="tid" value="<?php echo $_SESSION['id']; ?>" style="width:50%;">
                       ...
                       <div class="form-group">
<button type="submit" name="submit1" class="form-control btn btn-primary pull-right" style="width:45%;">Edit</button>    
                       </form>
<?php                        
 ?>
...
<form action="action_res.php" method="post">
 ...
 <h2> Total Marks:</h2><hr style="width:100%;margin-left:-1px;margin-top:-1px;">
                        <select id="class" class="form-control" name="total" style="width:100%;" >
...
<input type="number"  name="marks[]" value=""  style="text-align:center;">             
          </div>                         
                            </td>
...
$term = $_POST['term'];
$query1 = "SELECT * FROM `result` WHERE `class`='$class' AND `subject`='$subject' AND `term`='$term' AND `t_id`='$teacher' AND `section`='$section' AND `year`='$year' ";
                                           $result2 = mysqli_query($link, $query1);
...
<input  class="form-control" type="hidden" required="" name ="tid" value="<?php echo $_SESSION['id']; ?>" style="width:50%;">
 ...
 <button type="submit" name="submit1" class="form-control btn btn-primary" style="width:200px;">Delete</button>
                                             </form>
</div>
 <div class="col-md-6">
<form action="edit_res1.php" method="post">
...
<input  class="form-control" type="hidden" required="" name ="tid" value="<?php echo $_SESSION['id']; ?>" style="width:50%;">
                       ...
                       <div class="form-group">
<button type="submit" name="submit" class="form-control btn btn-primary pull-right" style="width:200px;">Edit</button>    
                       </form>
                     </div></div>
...
$a=1;
  ...
  <td class=" " style="text-align:center;">
                           ...
                           <div class="input-box fullname">
<input type="number"  name="marks[]" value=""  style="width:50%;text-align:center;">             
          </div>                         
                            </td>
...
<div class="col-md-12 col-sm-12 col-xs-12">
                       <div class="form-group">
<button type="submit" name="submit1" class="form-control btn btn-primary pull-right" style="width:150px;">Done</button>  
</div> </div>
                       </form>
