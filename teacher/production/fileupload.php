...
<html lang="en">
 ...
 <h2 style="color:red"><?php error_reporting(0); echo $_GET['msg']; ?></h2>
                        ...
                        <h3>Choose File to upload</h3>  
                               ...
                               <form id="demo-form" data-parsley-validate action="uploadpdf1.php" method="post" enctype="multipart/form-data">
...
<?php   $date = $_POST['date'];
 ...
 <input type="hidden" id="confirm_password" class="form-control" name="subject" value="<?php  echo $subject; ?> " required placeholder="">
                      ...
                      <input type="file" id="image" class="form-control btn btn-primary" name="myfile" data-parsley-trigger="change" required />
 <br>
