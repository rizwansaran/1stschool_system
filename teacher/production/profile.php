 ...
 <?php
   $id= $_SESSION['id'];
                       ...
                       $row = mysqli_fetch_array($result);
                        ?>
                                		         <img src="<?php echo $row['image'];?>" class="img-responsive" width="60" height="60"  alt="<?php echo $row['fullname']; ?>"/>	
...
<tr>
                                                <th scope="row">7</th>
                                                <td colspan="2">Address<br><i><?php echo $row['address']; ?></i></td>
...
<h2 style="color:red"><?php error_reporting(0); echo $_GET['msg']; ?></h2>
                        ...
                        <h3>Update display picture</h3>  
                               ...
                               <li> <form id="demo-form" data-parsley-validate action="uploadimage.php" method="post" enctype="multipart/form-data">
...
<li>             <form action="new_pw.php" method="POST">
