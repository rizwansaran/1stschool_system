      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          <div class="">
            ...
            <?php
$tid= $_SESSION['id'];
 $query1 = "SELECT DISTINCT year FROM `result` WHERE `t_id`='$tid' ORDER BY year DESC";
...
?>
          ...
          <input type="hidden" id="" value="<?php echo $year;?>" name="year">         
...
<?php
$tid= $_SESSION['id'];
 $query1 = "SELECT DISTINCT class FROM `result` WHERE `t_id`='$tid' AND `year`='$year'";
                        $result1 = mysqli_query($link, $query1);
...
<?php
$tid= $_SESSION['id'];
 $query11 = "SELECT DISTINCT section FROM `result` WHERE `t_id`='$tid' AND `year`='$year'";
...
<?php
$tid= $_SESSION['id'];
 $query12 = "SELECT DISTINCT term FROM `result` WHERE `t_id`='$tid' AND `year`='$year'";
