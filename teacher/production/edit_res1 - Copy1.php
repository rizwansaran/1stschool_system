...
<?php 
 ...
 //$section=$_POST['section'];
                          ...
                          $query3 = "SELECT marks FROM `result` WHERE `subject`= '$subject' AND `studentid`='$stdid' AND `term`='$term' AND `year`='$year'";
...
<input type="text"  name="marks[]" value="<?php echo $r2; ?>"  style="width:15%;text-align:center;">             
          </div>                         
                            </td>
