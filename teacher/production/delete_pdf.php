...
<?php
$tid= $_SESSION['id'];
 $query1 = "SELECT DISTINCT class FROM `pdf` WHERE `t_id`='$tid'";
...
<?php
$tid= $_SESSION['id'];
 $query11 = "SELECT DISTINCT section FROM `pdf` WHERE `t_id`='$tid'";
...
<?php
 $teacher= $_SESSION['id'];
 $section=$_POST['section'];
$quer11 = "SELECT DISTINCT subject FROM `pdf` WHERE `t_id`=' $teacher' AND `class`='$class' AND `section`='$section'";
...
$section = $_POST['section'];
 $teacher= $_SESSION['id'];
   $query3 ="DELETE FROM `pdf` WHERE `t_id`=' $teacher' AND `class`='$class' AND `subject`='$subject' AND `section`='$section'";
