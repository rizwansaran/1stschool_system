                ...
                <div class="x_panel">
                  ...
                  <div class="col-md-8">
                    <div class="row">
                       ...
                       <h2> Select the Student:</h2><hr style="width:20%;margin-left:-1px;margin-top:-1px;">
                        <select id="class" class="form-control" name="toid" style="width:50%;" >
<?php 
$tid= $_SESSION['id'];
 $qu = "SELECT DISTINCT class FROM `subject` WHERE `t_id`='$tid' ";
...
?>
 ...
 $toid = $_POST['toid'];
    $msg = $_POST['msg'];
                        ...
                        $quer = "SELECT * FROM `conversation` WHERE `teacherid`='$fromid' AND `studentid`='$toid'";
                        $resul = mysqli_query($link, $quer);
                        if($resul && mysqli_num_rows($resul) < 1){
                        
    $query = "INSERT INTO `conversation`(`studentid`, `teacherid`) VALUES ('$toid','$fromid' ) ";
$result = mysqli_query($link, $query);

$quer1 = " SELECT * FROM `conversation` WHERE `teacherid`='$fromid' AND `studentid`='$toid'";
...
{
    $quer2 = " SELECT * FROM `conversation` WHERE `teacherid`='$fromid' AND `studentid`='$toid'";
