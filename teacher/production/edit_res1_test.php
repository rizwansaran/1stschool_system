...
?>
   <form action="action_edit_res_test.php" method="post">
                    <div class="col-md-12">
...
?>
                        <tbody>
<?php
$query1 = "SELECT * FROM `result1` WHERE `class`='$class' AND `subject`='$subject' AND `term`='$term'AND `month`='$month' AND `t_id`='$teacher' AND `section`='$section' AND `year`='$year' ORDER BY id ASC ";
...
<input type="text"  name="marks[]" value="<?php echo $marks; ?>"  style="width:25%;text-align:center;">             
          </div>                         
                            </td>
...
<button type="submit" name="submit1" class="form-control btn btn-primary pull-right" style="width:25%;">Done</button>    
                       </form>
